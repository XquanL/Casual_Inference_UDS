...
knitr::include_graphics('/Users/genesisqu/Desktop/Duke/IDS701/uds-2023-team-1/30_intermediate_files/EDA_1.png')
```
...
```{r, echo = FALSE, fig.align='center', out.width = "200px", out.height = "150px"}
knitr::include_graphics('/Users/genesisqu/Desktop/Duke/IDS701/uds-2023-team-1/30_intermediate_files/EDA_2.png')
```
...
```{r, echo = FALSE, fig.align='center', out.width = "200px", out.height = "150px"}
knitr::include_graphics('/Users/genesisqu/Desktop/Duke/IDS701/uds-2023-team-1/30_intermediate_files/EDA_3.png')
```
...
Below are two hand-drawn regression tables showing model results if our hypothesis is true and if our hypothesis is false. Since our null hypothesis is that hybrid/online schooling has no effects on US students' anxiety levels during year 2021-2022, these are our hypothetical model results:

#### *Hypothesis == True*

```{r, echo = FALSE, fig.align='center', out.width = "400px", out.height = "250px"}
knitr::include_graphics('/Users/genesisqu/Desktop/Duke/IDS701/uds-2023-team-1/30_intermediate_files/Model_Results_T.jpg')
```

#### *Hypothesis == False*

```{r, echo = FALSE, fig.align='center', out.width = "400px", out.height = "250px"}
knitr::include_graphics('/Users/genesisqu/Desktop/Duke/IDS701/uds-2023-team-1/30_intermediate_files/Model_Results_F.jpg')
```
